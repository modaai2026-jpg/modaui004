...
export default function AITeamsView({ onBackToLanding, initialIndustryId }: { onBackToLanding: () => void; initialIndustryId?: string }) {
  const [selectedIndustry, setSelectedIndustry] = useState<string>(
    initialIndustryId || localStorage.getItem('preview_industry_id') || 'fashion'
  );
